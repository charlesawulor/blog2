...
<div class="banner-1">
	...
	while ($row = mysqli_fetch_array($run))
	{
		...
		<div class='col-md-9 technology-left'>
		  ...
		  <h2 class='w3'>SINGLE PAGE</h2>
			<div class='single'>
			   <img src='admin/post_image/$postimg' class='img-responsive' alt=''>
			    <div class='b-bottom'> 
			      <h5 class='top'>$posttitle</h5>
				   <p class='sub'>$postcon</p>
			      <p>On $postdate</p>
	...
	?>
					...
					<?php
					$fetch="select * from commenttbl where postid='$id'";
					...
					<DIV id='rform' style='width:100%;height:auto;display:NONE'>
							<form method='post' >
					<input type='text' value='reply ' name='rep' required=''>
						
						<input type='submit' name='send' value='Submit reply'>
		     	</form>
							</DIV>
					";
					?>
				<?php	
$sql1 = "select * from replytbl where commentid = '$comid'";
			...
			<script>
				...
				<div class='coment-form'>
					...
					<form method='post'>
						...
						<input type='email' value='Email' name='mail' required=''>
						
						<input type='text' value='Website' name='web' required=''>
...
if(isset($_POST["submit"])){
	...
	$comment=$_POST['comment'];
		...
		$ff="INSERT INTO `commenttbl`(`commentid`, `postid`, `name`, `email`, `website`, `comment`)
		VALUES ('','$id','$name','$mail','$web','$comment')";
	...
	
{
	...
	$rep=$_POST['rep'];
		...
		$ff="INSERT INTO `replytbl`  (`replyid`, `commentid`, `reply`) VALUES ('','$comid','$rep')";
